...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "4d54bd6f9235eadd76f1";
...
/* harmony import */ var _thunk__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./thunk */ "./src/thunk.js");
...
var configureStore = function () {
  ...
  if (true) {
    store.dispatch = Object(_logger__WEBPACK_IMPORTED_MODULE_1__["addLoggingToDispatch"])(store);
  }

  store.dispatch = Object(_thunk__WEBPACK_IMPORTED_MODULE_2__["addPromiseSupportToDispatch"])(store);
  return store;
}();
...
/*!***********************!*\
  !*** ./src/logger.js ***!
  \***********************/
/*! exports provided: addLoggingToDispatch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addLoggingToDispatch", function() { return addLoggingToDispatch; });
/**  
 *  中间件 增强dispatch的功能 
...
var addLoggingToDispatch = function addLoggingToDispatch(store) {
  console.log(111);
  console.log(store); // 该函数应该 在行为上同dispatch保持一致，因此这个函数要返回一个新的函数

  var rawDispatch = store.dispatch;
  return function (action) {
    // 按照action类型输出分组
    console.group(action.type); // 打印更新前的state

    console.log('%c previous state', 'color:red', store.getState()); // 打印当前的action

    console.log('%c action', 'color:red', action);
    var returnValue = rawDispatch(action); // 打印更新后额state
...
/*!**********************!*\
  !*** ./src/thunk.js ***!
  \**********************/
/*! exports provided: addPromiseSupportToDispatch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addPromiseSupportToDispatch", function() { return addPromiseSupportToDispatch; });
/** 
 *  redux.thunk雏形
 */
var addPromiseSupportToDispatch = function addPromiseSupportToDispatch(store) {
  var rawDispatch = store.dispatch;
  return function (action) {
